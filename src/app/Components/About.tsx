...
//                 <Link href="#" className="text-gray-500 hover:text-black"><FaTwitter /></Link>
//                 <Link href="#" className="text-gray-500 hover:text-black"><FaInstagram /></Link>
//                 <Link href="#" className="text-gray-500 hover:text-black"><FaLinkedinIn /></Link>
//               </div>
//             </div>
//           ))}
//         </div>
